...
export default function ProductCard({ product, style={} }) {
  ...
  // Promoted товары всегда светятся, обычные — только при hover
  const showElectric = product.isPromoted || hovered
  ...
  return (
    ...
    >
      <ElectricBorder
        color={electricColor}
        speed={product.isPromoted ? 1.2 : 0.8}
        chaos={product.isPromoted ? 0.14 : 0.10}
        borderRadius={20}
        style={{ opacity: showElectric ? 1 : 0, transition: 'opacity 0.3s ease' }}
      >
